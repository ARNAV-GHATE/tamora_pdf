...
with open(pdf_path, "rb") as file:
            ...
            for page_num in range(num_pages):
                ...
                if tables:
                    ...
                    for table_num, table in enumerate(tables):
                        ...
                        json_file_path = f"D:/PROJECTS/HarshitFreelance/scrapper/Table_Zerodha/table_{page_num + 1}_{table_num + 1}.json"
                        ...
                        csv_path = f"D:/PROJECTS/HarshitFreelance/scrapper/Table_Zerodha/table_{page_num + 1}_{table_num + 1}.csv"
                        ...
                        # csv_path = r'D:\PROJECTS\HarshitFreelance\scrapper\Table_Zerodha\table_{page_num + 1}_{table_num + 1}.csv'
                        # json_path = r'D:\PROJECTS\HarshitFreelance\scrapper\Table_Zerodha\new_table_{page_num + 1}_{table_num + 1}.json'
    ...
    #             print("Text and tables saved to file successfully.")
    #             print(text)
    #             print("\n")
    #     else:
    #         # Incorrect password
    #         print("Incorrect password for the PDF.")
    # else:
